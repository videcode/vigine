...
static_cast<render::OpenGL::Render*>(this->pRend);
    ...
    this->cmap = X11::XCreateColormap(this->dpy, this->root, this->vi->visual,
AllocNone); this->swa.colormap = this->cmap; this->swa.event_mask = ExposureMask
| KeyPressMask		| ButtonPressMask	| ButtonReleaseMask	|
    ...
    this->win = X11::XCreateWindow(this->dpy,
                                   this->root, 0, 0, this->width_,
this->height_, 0, this->vi->depth, InputOutput, this->vi->visual, CWColormap |
...
*/
    ...
    this->win = XCreateWindow(this->dpy, this->root, 0, 0, this->width_,
                              this->height_, 0, 0, InputOutput, CopyFromParent,
                              CWColormap | CWEventMask, &this->swa);
  }
  ...
  DRAW:
    ...
    /*
                        render::OpenGL::glXSwapBuffers(this->dpy, this->win);
                            ...
                            render::OpenGL::glClear( GL_COLOR_BUFFER_BIT |
       GL_DEPTH_BUFFER_BIT );
    */
#else
#ifdef RENDER_VULKAN

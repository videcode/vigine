...
void PipelineGraphic::init(std::shared_ptr<vk::Device> psLogicDevice) {
  ...
  // psLogicDevice->createGraphicsPipeline(this->pipelineCahe,
  // this->createInfo);

...
void graphics::vulkan::print_prop(vk::QueueFamilyProperties &prop,
                                  std::string str) {
  using namespace std;
  if (!str.empty())
    print("--- " + str + " ---");
...
typedef struct VkSurfaceCapabilitiesKHR {
  ...
  */
  ...
  print_bit(var.supportedTransforms, vk::SurfaceTransformFlagBitsKHR::eIdentity,
            ".supportedTransforms.eIdentity");
  print_bit(var.supportedTransforms, vk::SurfaceTransformFlagBitsKHR::eRotate90,
            ".supportedTransforms.eRotate90");
  print_bit(var.supportedTransforms,
            vk::SurfaceTransformFlagBitsKHR::eRotate180,
            ".supportedTransforms.eRotate180");
  print_bit(var.supportedTransforms,
            vk::SurfaceTransformFlagBitsKHR::eRotate270,
            ".supportedTransforms.eRotate270");
  print_bit(var.supportedTransforms,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirror,
            ".supportedTransforms.eHorizontalMirror");
  print_bit(var.supportedTransforms,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate90,
            ".supportedTransforms.eHorizontalMirrorRotate90");
  print_bit(var.supportedTransforms,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate180,
            ".supportedTransforms.eHorizontalMirrorRotate180");
  print_bit(var.supportedTransforms,
  ...
  print_bit(var.currentTransform, vk::SurfaceTransformFlagBitsKHR::eRotate90,
            ".currentTransform.eRotate90");
  print_bit(var.currentTransform, vk::SurfaceTransformFlagBitsKHR::eRotate180,
            ".currentTransform.eRotate180");
  print_bit(var.currentTransform, vk::SurfaceTransformFlagBitsKHR::eRotate270,
            ".currentTransform.eRotate270");
  print_bit(var.currentTransform,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirror,
            ".currentTransform.eHorizontalMirror");
  print_bit(var.currentTransform,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate90,
            ".currentTransform.eHorizontalMirrorRotate90");
  print_bit(var.currentTransform,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate180,
            ".currentTransform.eHorizontalMirrorRotate180");
  print_bit(var.currentTransform,
            vk::SurfaceTransformFlagBitsKHR::eHorizontalMirrorRotate270,
  ...
  print_bit(var.supportedCompositeAlpha,
            ...
            ".supportedCompositeAlpha.ePreMultiplied");
  print_bit(var.supportedCompositeAlpha,
            vk::CompositeAlphaFlagBitsKHR::ePostMultiplied,
            ".supportedCompositeAlpha.ePostMultiplied");
  print_bit(var.supportedCompositeAlpha,
  ...
  print_bit(var.supportedUsageFlags, vk::ImageUsageFlagBits::eStorage,
            ".supportedUsageFlags.eStorage");
  print_bit(var.supportedUsageFlags, vk::ImageUsageFlagBits::eColorAttachment,
            ".supportedUsageFlags.eColorAttachment");
  print_bit(var.supportedUsageFlags,
            vk::ImageUsageFlagBits::eDepthStencilAttachment,
            ".supportedUsageFlags.eDepthStencilAttachment");
  print_bit(var.supportedUsageFlags, vk::ImageUsageFlagBits::eInputAttachment,
            ".supportedUsageFlags.eInputAttachment");
  print_bit(var.supportedUsageFlags,
            vk::ImageUsageFlagBits::eTransientAttachment,
            ".supportedUsageFlags.eTransientAttachment");
  print_bit(var.supportedUsageFlags,
            vk::ImageUsageFlagBits::eFragmentShadingRateAttachmentKHR,
            ".supportedUsageFlags.eFragmentShadingRateAttachmentKHR");
  print_bit(var.supportedUsageFlags,
